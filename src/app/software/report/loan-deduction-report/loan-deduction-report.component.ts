...
@Component({
  selector: 'app-loan-deduction-report',
  templateUrl: './loan-deduction-report.component.html',
  styleUrls: ['./loan-deduction-report.component.css']
})
export class LoanDeductionReportComponent implements OnInit {
  ...
  public async printCaseDTR() {
    ...
    this._otherIncomePayslipSubscription = (await this.reportService.LoanDeductionReport(this.payrollId)).subscribe(
      data => {
        var binaryData = [];
