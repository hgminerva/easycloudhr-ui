...
@Component({
  selector: 'app-payroll-other-deduction-report',
  templateUrl: './payroll-other-deduction-report.component.html',
  styleUrls: ['./payroll-other-deduction-report.component.css']
})
export class PayrollOtherDeductionReportComponent implements OnInit {
  ...
  public async printCaseDTR() {
    ...
    this._incomeOrDeductionReportSubscription = (await this.reportService.PayrollOtherDeduction(this.payrollId)).subscribe(
      data => {
        var binaryData = [];
